...
<div class="bg-white p-6 rounded-2xl shadow-md">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Tambah Portofolio</h2>

    <form action="{{ route('admin.porto.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
        @csrf

        {{-- Nama Portofolio --}}
        <div>
            <label class="block text-gray-600 font-medium mb-2">Nama Portofolio</label>
            <input type="text" name="nama_portofolio" value="{{ old('nama_portofolio') }}"
        ...
        <div class="flex justify-end">
            <a href="{{ route('admin.porto') }}" class="px-4 py-2 bg-gray-200 rounded-lg text-gray-700 hover:bg-gray-300 transition mr-2">Batal</a>
            <button type="submit"
